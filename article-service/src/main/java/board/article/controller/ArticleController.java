...
public class ArticleController {
    ...
    public ArticleResponse create(@RequestBody ArticleRequest.Create request) {
        return articleService.create(request);
    }

    @PutMapping("/v1/articles/{articleId}")
    public ArticleResponse update(@PathVariable Long articleId, @RequestBody ArticleRequest.Update request) {
